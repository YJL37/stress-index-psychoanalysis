...
sample_data = ["two people mixing something with CNN", "clapping with CNN", "two devils with CNN", "two panthers with CNN", "two horsefish with CNN"]
